...
class TelaDoacao(AbstractTela, AbstractTelaPessoa, AbstractTelaAnimal, AbstractTelaAcao):
    def __init__(self):
        super().__init__()
    ...
    def pega_dados_doacao(self):
        ...
        return {"cpf_doador": cpf_doador, "nome_animal": nome_animal, "chip_animal": chip_animal, "raca_animal": raca_animal, "vacinas_animal": vacinas_animal, "motivo_doacao": motivo_doacao}
